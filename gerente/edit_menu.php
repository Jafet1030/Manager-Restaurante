...
$stmt = $pdo->prepare("
    SELECT 
      id, nombre, descripcion, categoria, precio_local, precio_entrega, precio_takeaway, alergenos, food_cost, activo
    FROM menu
    WHERE id = ?
");
$stmt->execute([$id]);
...
<body class="bg-gray-100 text-gray-800 pt-16">
  ...
  <main class="max-w-md mx-auto p-6">
    <section class="bg-white rounded-lg shadow p-6 animate-fade-in-up">
      <h2 class="text-2xl font-semibold mb-4">Editar Platillo</h2>
